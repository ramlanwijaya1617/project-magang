        ...
        <nav class="px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                <a href="#" class="flex items-center">
                    <img src="../assets/image/image 111.svg" class="mr-3 h-6 sm:h-10" alt="Flowbite Logo">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SMKN 1
                        Cibadak</span>
                </a>
                    ...
                    <ul
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar"
                                ...
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(370px, 65.5556px);">
